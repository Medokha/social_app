                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              OutlinedButton(
                                  onPressed: () {
                                    Navigator.pushNamed(context, update.routname,
                                        arguments:  ardssetting(taskes.single.image, taskes.single.cover));
                                  ...
                                  child: Column(
                                    children: [
                                      StreamBuilder<QuerySnapshot<post>>(
                                          stream: getpostFirebaseFirestore(user_singin.single.id),
                                          builder: (context,snapshot){
                                            if(snapshot.connectionState==ConnectionState.waiting){
                                              return Center(child: CircularProgressIndicator());
                                            }
            ...
            children: [
              Expanded(
                child: Row(
                  children: [
                    CircleAvatar(
                      backgroundImage: NetworkImage("${user_singin.image}"),
                      radius: 20,
                    ),
                    SizedBox(width: 20,),
                    InkWell(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      TextButton(onPressed: (){
                                        comment comments =comment(text: _comment.text, id_user: user_singin.id,  id_post:  post.id);
                        ...
                        child: Text("Write commet ... ",style: TextStyle(fontSize: 18,color: Colors.grey),)) ,
                  ],
                ),
              ),
              InkWell(
                onTap: (){
                  likes mylike =likes(id_user: user_singin.id, like: true, id_post: post.id);
